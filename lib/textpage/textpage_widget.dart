...
import 'textpage_model.dart';
export 'textpage_model.dart';

class TextpageWidget extends StatefulWidget {
  const TextpageWidget({Key? key}) : super(key: key);

  @override
  _TextpageWidgetState createState() => _TextpageWidgetState();
}
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          top: true,
          child: wrapWithModel(
            model: _model.startWorkoutModel,
